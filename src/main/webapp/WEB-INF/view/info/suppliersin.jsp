            ...
            <div class="col-md-8 col-md-offset-2 col-sm-4 col-sm-offset-2">
                <div id="login">
                    <div class="text-center"><img src="/img/logo_black.png" alt="" data-retina="true"><span
                            class="supplierIn"><spring:message code="supplierIn"/></span></div>
                    <hr>
                    <form id="supplierregister">
                        <div class="col-md-12 col-sm-12 ">
                            ...
                            <div class="col-md-6 col-sm-12 ">
                                <div class="form-group">
                                    <label><spring:message code="supplierName"/></label>
                                    <input type="text" class=" form-control" id="supplierName" name="supplierName"
                                           placeholder="<spring:message code="supplierName"/>">
                                </div>
                                <%--<div class="form-group">--%>
                                ...
                                <%--</div>--%>
                                <div class="form-group">
                                    <label><spring:message code="supplierAddress"/></label>
                                    <input type="text" class=" form-control" id="supplierAddress" name="supplierAddress"
                                           placeholder="<spring:message code="supplierAddress"/>">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label><spring:message code="supplierwebsite"/></label>
                                    <input type="text" class=" form-control" id="website" name="website"
                                           placeholder="<spring:message code="supplierwebsite"/>">
                                </div>
                            </div>
                            <div class="col-md-6 col-sm-12 ">
                                <div class="form-group">
                                    <label><spring:message code="legalPeople"/></label>
                                    <input type="text" class=" form-control" id="legalPeople" name="legalPeople"
                                           placeholder="<spring:message code="legalPeople"/>">
                                </div>
                                <div class="form-group">
                                    <label><spring:message code="supplierlicense"/></label>
                                    <input type="text" class=" form-control" id="license" name="license"
                                           placeholder="<spring:message code="supplierlicense"/>">
                                </div>
                                <div class="form-group">
                            ...
                            <div class="col-md-12 col-sm-12">
                                <div class="form-group">
                                    <label><spring:message code="supplierdescription"/></label>
                                <textarea rows="5" id="description" name="description" class="form-control"
                                          placeholder="<spring:message code="supplierdescription"/>"
                        ...
                        <div align="right">
                            <input type="button" id="registerSupplier" class="btn_1"
...
<script src="/js/supplier/supplierregister.js"></script>
<script>
    ...
    var sup_submit = $("#registerSupplier");
</script>
